...
private:
	 ...
	 *     Out of memory.
	 */
	ErrorCode http2_session_terminate_session(Session session, FrameError error_code);
	 ...
	 */
	bool http2_session_is_my_stream_id(Session session,	int stream_id);
	 ...
	 *     Out of memory.
	 */
	ErrorCode http2_session_add_rst_stream(Session session, int stream_id, FrameError error_code);
	 ...
	 *     Out of memory.
	 */
	ErrorCode http2_session_add_ping(Session session, FrameFlags flags, const ubyte *opaque_data);
	 ...
	 *     Out of memory.
	 */
	ErrorCode http2_session_add_window_update(Session session, FrameFlags flags, int stream_id, int window_size_increment);
	 ...
	 *     Out of memory.
	 */
	ErrorCode http2_session_add_settings(Session session, FrameFlags flags, const http2_settings_entry *iv, size_t niv);
	 ...
	 * null.
	 */
	Stream http2_session_open_stream(Session session, int stream_id, StreamFlags flags, PrioritySpec pri_spec, http2_stream_state initial_state, void *stream_user_data);
